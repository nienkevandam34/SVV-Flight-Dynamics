...
print("symmetric: ") 
print("Short period oscillation: ", labda_1, labda_2)
print("Phugoid: ",labda_3, labda_4)
...
print("asymmetric: ")
print("Highly damped aperiodic rolling: ",labda_5)
print("Dutch roll: ", labda_6, labda_7)
print("Aperiodic spiral motion: ", labda_8)